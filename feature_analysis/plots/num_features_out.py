...
sns.set_theme()
f1s_loc = "/Users/zolboo/research/research/feature_analysis/f1s_out.pkl"
f1s_pkts = "/Users/zolboo/research/research/feature_analysis/f1s_out_pkts.pkl"
f1s_pca = "/Users/zolboo/research/research/feature_analysis/f1s_out_pca.pkl"
f1s_pca_pkts = "/Users/zolboo/research/research/feature_analysis/f1s_out_pca_pkts.pkl"
f1s_variance = "/Users/zolboo/research/research/feature_analysis/f1s_out_pca_variance.pkl"
f1s_variance_pkts = "/Users/zolboo/research/research/feature_analysis/f1s_out_pca_variance_pkts.pkl"  
...
with open(f1s_pca, "rb") as f:
    ...
    plt.savefig(f"num_features_out_all.png")
    plt.clf()
...
with open(f1s_pca_pkts, "rb") as f:
    ...
    plt.title(f"F1 Score as features are added")
    plt.legend(bbox_to_anchor = (1, 0), loc = 'lower right')
    plt.savefig(f"num_features_out_pkts.png")
    plt.clf()
...
with open(f1s_variance_pkts, "rb") as f:
    ...
    plt.legend(bbox_to_anchor = (1, 0), loc = 'lower right')
    plt.savefig(f"num_features_out_variance_pkts.png")
    plt.clf()
...
with open(f1s_variance, "rb") as f:
    ...
    plt.title(f"Variance of the features with the highest variance")
    plt.legend(bbox_to_anchor = (1, 0), loc = 'lower right')
    plt.savefig(f"num_features_out_variance.png")
    plt.clf()